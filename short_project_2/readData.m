...
%             FPImageInfo = dir('/Users/jallen/Documents/MATLAB/short_project_2/nifti_data/20150714_100527pjep2dsefpList2burstoffs033a1001.nii.gz');        
 ...
 %       TEImageInfo = dir('/Users/jallen/Documents/MATLAB/short_project_2/nifti_data/20150806_125113ep2dseTE*');
  ...
  TEImageInfo = dir('/Users/jallen/Documents/MATLAB/short_project_2/nifti_data/20150819/20150819_142314pjep2dseTE*');
  TIImageInfo = dir('/Users/jallen/Documents/MATLAB/short_project_2/nifti_data/20150819/20150819_142314IRep2dseT1*');
        
%         FPImageInfo = dir('/Users/jallen/Documents/MATLAB/short_project_2/nifti_data/20150714_100527pjep2dsefpList2burstoffs033a1001.nii.gz');
         FPImageInfo = dir('/Users/jallen/Documents/MATLAB/short_project_2/nifti_data/20150806_125113pjep2dsefpList22sltr132stas072a1001.nii.gz');
        ...
        for TE_ind = 1:numel(TE)
            ...
            for i = 1:size(TEImageInfo,1)
                ...
                if strfind(TEImageInfo(i).name,['TE',num2str(TE(TE_ind))]) > 0
                    filename = ['/Users/jallen/Documents/MATLAB/short_project_2/nifti_data/20150819/', TEImageInfo(i).name(1,:)];
        ...
        for TI_ind = 1:numel(TI)
            for i = 1:size(TIImageInfo,1)
                ...
                if strfind(TIImageInfo(i).name,['T1',num2str(TI(TI_ind))]) > 0
                    filename = ['/Users/jallen/Documents/MATLAB/short_project_2/nifti_data/20150819/', TIImageInfo(i).name(1,:)];
        ...
        %FINGERPRINTING IMAGES
        filename = ['/Users/jallen/Documents/MATLAB/short_project_2/nifti_data/', FPImageInfo.name(1,:)];
