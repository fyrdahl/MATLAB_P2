function [similarity, matchedT1, matchedT2, matchedFAdev, M0fit_grad, bestMatch, el] = calcSimilarity(data, signalDictionary, nTimeCoursePts, dictionaryParams, workingdir)
% Author: Jack Allen.
