...
%remove dead time
%spiralkspacelocations_x(GRX==0)=[];
%spiralkspacelocations_y(GRY==0)=[];
...
% for n = 1:nTRs
% tmpspiralkspacelocations = complex(spiralkspacelocations_x(1,((n*(nTotalPts)-(nTotalPts-1) : (n*(nTotalPts)-(nTotalPts-1)+nSamplePts-1 )))), ...
%     spiralkspacelocations_y(1,((n*(nTotalPts)-(nTotalPts-1)) : (n*(nTotalPts)-(nTotalPts-1)+nSamplePts-1 ))));
