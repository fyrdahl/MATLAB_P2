...
FIDstart = 18464;
% Read data from file
filename20160718 = (['~/Documents/DPhil/data/TWIX/',date,'/meas_MID',num2str(MIDstart+scanIndex),'_JA_IR_bSSFP_fp__',num2str(abs(ADCshift)),'ADC_FID',num2str(FIDstart+scanIndex)]);
...
spiralkspacedata = double(squeeze(image_data20160718(:,channel,TRrange)));
