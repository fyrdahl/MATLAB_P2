...
spiralkspacelocations_x = 0.5*spiralkspacelocations_x/max(abs(spiralkspacelocations_x));
spiralkspacelocations_y = 0.5*spiralkspacelocations_y/max(abs(spiralkspacelocations_y));
