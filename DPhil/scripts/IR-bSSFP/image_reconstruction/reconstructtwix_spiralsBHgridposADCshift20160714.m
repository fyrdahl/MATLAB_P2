...
FIDstart = 17949;
% Read data from file
filename20160714 = (['~/Documents/DPhil/data/TWIX/',date,'/meas_MID',num2str(MIDstart+scanIndex),'_JA_IR_bSSFP_fp_',num2str(ADCshift),'ADC_FID',num2str(FIDstart+scanIndex)]);
...
spiralkspacedata = double(squeeze(image_data20160714(:,channel,((3*nTRs)+1):((3*nTRs)+nTRs))));
