...
%
date = '20160621'; %date of scan
% read raw scanner data (TWIX)
ADCshifts = [-40,-30,-20,-10,-7,-3,3,7];
ADCshift_index = 8;
...
% read data from file
filename = (['~/Documents/DPhil/data/TWIX/',date,'/meas_MID',num2str(198+scanIndex),'_JA_IR_bSSFP_fp_NOINV_',num2str(ADCshift),'_FID',num2str(16122+scanIndex)]);
...
spiralkspacedata = double(squeeze(image_data(:,1:nTRs)));
