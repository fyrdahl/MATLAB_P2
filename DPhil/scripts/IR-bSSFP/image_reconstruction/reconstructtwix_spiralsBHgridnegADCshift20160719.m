...
FIDstart = 18847;
% Read data from file
filename20160719 = (['~/Documents/DPhil/data/TWIX/',date,'/meas_MID',num2str(MIDstart+scanIndex),'_JA_IR_bSSFP_fp__',num2str(abs(ADCshift)),'ADC_FID',num2str(FIDstart+scanIndex)]);
