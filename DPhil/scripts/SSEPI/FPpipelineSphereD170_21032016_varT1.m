...
[dictionaryOL20PL9,sdelT] = compile_SE_dictionary(offsetList, nTimeCoursePts, nSlices, df, dictionaryParams);

% Check similarity scores and use dictionary to assign values of T1, T2 etc.

[matchedT1OL20PL9, matchedT2OL20PL9, matchedFAdevOL20PL9, M0fit_gradOL20PL9, bestMatchOL20PL9, matchTimeOL20PL9, maxSimilarity, similarity, degeneracyMap] = calc_similarity(FPdata, dictionaryOL20PL9, dictionaryParams);
...
%[maxSimilarity2, matchedT12, matchedT22, matchedFAdev2, M0fit_grad2, bestMatch2, matchTime2] = calcSimilarity2(FPdata, sd, dictionaryParams);


%%


plot_Matched_maps(matchedT1OL20PL9, matchedT2OL20PL9, matchedFAdevOL20PL9, M0fit_gradOL20PL9)


%%
plot_TCs(FPdata,'fp',bestMatchOL20PL9)
